...
const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "view_investor_wallets", label: "عرض محافظ المستثمر" },
      { key: "view_investor_wallet_statements", label: "عرض كشوف محافظ المستثمر" },
      { key: "deposit_investor_cash_wallet", label: "إضافة رصيد للمحفظة النقدية" },
      { key: "withdraw_investor_cash_wallet", label: "سحب رصيد من المحفظة النقدية" },
      { key: "adjust_investor_goods_quantity", label: "تعديل كمية سلع المستثمر" },
      { key: "initialize_investor_goods_cost", label: "تحديد التكلفة الافتتاحية لسلع المستثمر" },
      { key: "view_investor_goods_statement", label: "عرض كشف محفظة سلع المستثمر" },
      { key: "view_investor_contracts_wallet", label: "عرض محفظة عقود المستثمر" },
      { key: "view_investor_contracts_statement", label: "عرض كشف محفظة عقود المستثمر" },
      { key: "purchase_investor_goods", label: "شراء وإضافة سلع للمستثمر" },
    ],
  },
  {
