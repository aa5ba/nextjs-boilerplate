...
export default function ProductsReportPage() {
  ...
  async function loadReport() {
    ...
    try {
      ...
      if (error) {
        alert(error.message || "تعذر تحميل كشف حركة المنتجات");
        setItems([]);
        return;
      }
        ...
        <header style={getHeroStyle(isMobile)} className="no-print">
          ...
          <div style={getHeroContentStyle(screen)}>
            ...
            <div style={getHeroTitleBoxStyle(screen)}>
              <h1 style={getTitleStyle(screen)}>كشف حركة المنتجات</h1>
            </div>
        ...
        <section style={controlsCard} className="no-print">
          ...
          <div style={buttonsRow}>
            <button
              style={{
                ...primaryButton,
                opacity: initialLoading || loading ? 0.65 : 1,
                cursor: initialLoading || loading ? "not-allowed" : "pointer",
              }}
              onClick={loadReport}
              disabled={initialLoading || loading}
            >
